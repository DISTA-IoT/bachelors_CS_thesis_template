...
\begin{titlepage}
    \begin{center}
        ...
        {\large \textbf{UNIVERSITÀ DEGLI STUDI [NOME ATENEO]}} \\
        {\large \textbf{DIPARTIMENTO DI [NOME DIPARTIMENTO]}} \\
        ...
        % Sostituire img/logo_insu.jpeg con il logo ufficiale del proprio ateneo
...
\include{Cap1_introduzione}
\include{Cap2_background}
\include{Cap3_sistema}
\include{Cap4_implementazione}    
\include{Cap5_risultati}
\include{Cap6_conclusioni}
