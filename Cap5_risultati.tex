...
\centering
\small
\caption{Confronto quantitativo delle prestazioni sperimentali tra la soluzione proposta e le configurazioni di baseline.}
\label{tab:risultati-confronto}
\renewcommand{\arraystretch}{1.3}
\begin{tabular}{l c c c r}
\toprule
& \multicolumn{3}{c}{\textbf{Metriche di Classificazione}} & \multicolumn{1}{c}{\textbf{Efficienza}} \\
\cmidrule(lr){2-4} \cmidrule(lr){5-5}
\textbf{Configurazione Testata} & \textbf{Precision} & \textbf{Recall} & \textbf{F1-Score} & \textbf{Latenza (ms)} \\
\midrule
